exports.getDataByPage = (data, pageNumber = 1, pageSize = 20) => {
...
exports.getPaginationItems = (pageNumber, pageCount, pageSize = 20) => {
  let startItem = 1
...
exports.getPagination = (data, pageNumber = 1, pageSize = 20) => {
  ...
  pageSize = ([10, 20, 25, 50, 100].indexOf(parseInt(pageSize)) !== -1) ? parseInt(pageSize) : 20
